...
Revenue Assistant API request 範囲、Revenue Assistant write API endpoint、rank change payload、pending 秒数、candidate scoring、priority、confidence、reasonFingerprint、保存 schema、Tampermonkey installed version は変更していない。
