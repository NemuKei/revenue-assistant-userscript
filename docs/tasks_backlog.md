...
- スコープ:
  ...
  - 部屋タイプと食事条件は、グラフ軸ではなく簡易絞り込みとして表示する。
...
- 受け入れ条件:
  ...
  - `1名`、`2名`、`3名`、`4名` の panel が表示され、対象データがない人数は `対象データなし` と表示される。
  - 部屋タイプと食事条件を指定なしから選択でき、選択後にグラフが再描画される。
...
- GUI 確認:
  ...
  - `1名 最安値`、`2名 最安値`、`3名 最安値`、`4名 最安値` の 4 panel と、部屋タイプ、食事条件の 2 select が表示されることを確認した。
