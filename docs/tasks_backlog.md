...
- 状態:
  - source実装とlocal gate完了、公開前。Topの可視hotel current優先、foreground 35ms / 30、scope別再読込とbatch描画を実装した。公開版、Tampermonkey、通常Chromeのpost-change sampleは未確認である。
- 解決する問題:
