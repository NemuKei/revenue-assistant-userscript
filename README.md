...
- Next公開版`0.2.0.11`は`RAU-UX-166`を含めて配信済みである。installed version / 有効状態はmutable stateなので次のlive作業前にもfresh確認し、Classic再公開は引き続き別gateとする。
...
2026-08-10にsource `6cfd82ad222c70537151eae96991e68ad6344480`をmanual workflow run `31360100862`で公開版`0.2.0.11`へ配信しました。公開Nextは281,011 bytes、SHA-256 `8D9E978273FBED7AB8C751877D3A65DD633F10D18214F3A3C1C4A4538CCEFBC3`でrelease manifestと一致し、Classic userscript / source mapは固定baselineと同一byte列です。
