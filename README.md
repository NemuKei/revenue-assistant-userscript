...
- Next公開版`0.2.0.16`は`RAU-MP-09`の月次実績拡張、loading先行表示、表示月基準の絶対年比較を含めて配信済みである。installed version / 有効状態はmutable stateなので次のlive作業前にもfresh確認し、Classic再公開は引き続き別gateとする。
