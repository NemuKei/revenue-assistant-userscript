...
2026-08-12にsource `fed091d3ea4e793d08a9f294c12c7c694cd17ade`をmanual workflow run `31568825506`で公開版`0.2.0.21`へ配信しました。公開Nextは353,544 bytes、SHA-256 `6D6D2239E19DA8069FC5DBB3D84BB772E02F1BAC232E278233A94E53432D1EB9`、source mapは1,362,728 bytes、SHA-256 `A1C6327A86A2E2A4B1830DDA91F0662AFC9ADC3A3C2E48AE818FC85AAAD3B9C2`でrelease manifestと一致し、build / deploy / verifyはすべてsuccess、Classic userscript / source mapは固定baselineと同一byte列です。Tampermonkey更新と、通常Chromeの販売設定で複数roomを開いた後に標準booking curveへ切り替えるlive request budget / write 0確認は公開後の別確認です。
