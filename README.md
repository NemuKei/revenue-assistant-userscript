...
- 現在のNext公開版`0.2.0.25`は、`0.2.0.24`の変更者Tooltipを維持しつつ、Top / Analyze / 競合価格の判断可能時間を段階別に測るprivacy-safe performance marker / collectorを追加した。source `adeff29a2aec6172d34dc839ac1c3a411d61a835`、manual workflow run `31672723475`のbuild / deploy / verify、公開artifact / Classic baseline照合、Tampermonkey更新、通常Chromeの初回live baselineまで完了した。Top、Analyze、選択room、競合価格は各1 sampleのため全cohort provisionalであり、SLO達成済みとは扱わない。
